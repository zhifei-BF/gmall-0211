...
public class PmsOssController {
    String accessId = "LTAI4GFhKoMevgZpM2eTs9NP"; // 请填写您的AccessKeyId。
    String accessKey = "ml4SL86HL8gGgh55OCLSmHTJ8Au2IY"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "gmall-07-22"; // 请填写您的 bucketname 。
